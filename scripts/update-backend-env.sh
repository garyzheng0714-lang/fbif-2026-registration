...
apply_defaults() {
  ...
  set_default FEISHU_FIELD_CLIENT_IP "ip"
  set_default FEISHU_FIELD_ACTUAL_SUBMITTED_AT "实际提交时间"
...
apply_overrides() {
  ...
  set_if_non_empty FEISHU_FIELD_CLIENT_IP "${FEISHU_FIELD_CLIENT_IP:-}"
  set_if_non_empty FEISHU_FIELD_ACTUAL_SUBMITTED_AT "${FEISHU_FIELD_ACTUAL_SUBMITTED_AT:-}"
  set_if_non_empty FEISHU_FIELD_CLIENT_REQUEST_ID "${FEISHU_FIELD_CLIENT_REQUEST_ID:-}"
