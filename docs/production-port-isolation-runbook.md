...
- 预览保留端口：
  - 外部稳定入口：`3003 -> 3101`
  - 预览蓝绿端口：`3101/3102`（Nginx）、`28080/28081`（API）
  - `8083` 仅作历史兼容口，不作为默认入口。
...
ssh aliyun-prod-real 'ss -ltnp | egrep ":3001|:3002|:3101|:3102|127.0.0.1:8080|127.0.0.1:18080|127.0.0.1:28080|127.0.0.1:28081"'
